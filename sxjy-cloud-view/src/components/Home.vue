  ...
  <el-row class="container">
    ...
    <el-col :span="24" class="main">
      ...
      <aside :class="{showSidebar:!collapsed}">
        ...
        <!--导航菜单-->
        <el-menu default-active="1-4-1" class="el-menu-vertical-demo" :default-active="defaultActiveIndex" router :collapse="collapsed" @select="handleSelect">
            <el-submenu index="1">
              <template slot="title">
              ...
              <el-menu-item-group>
                ...
                <el-menu-item index="/errorlog">错误日志</el-menu-item>
