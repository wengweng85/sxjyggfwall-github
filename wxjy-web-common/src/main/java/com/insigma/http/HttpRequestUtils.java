...
public class HttpRequestUtils<T> {
    ...
    private String zuul_base_url;

    //是否加解密
    private boolean isencrpty;
    
    public HttpRequestUtils(String zuul_base_url,boolean isencrpty) {
        jsonConfig = new JsonConfig();
        jsonConfig.registerJsonValueProcessor(Date.class, new JsonDateValueProcessor());
        this.zuul_base_url = zuul_base_url;
    ...
    public JSONObject httpPost(String url) throws AppException {
        try {
            HttpResult httpresult = HttpHelper.executePost(zuul_base_url + url, new HashMap(), isencrpty);
    ...
    public JSONObject httpPost(String url, HashMap map) throws AppException {
        try {
            HttpResult httpresult = HttpHelper.executePost(zuul_base_url + url, map,isencrpty);
            return parseHttpResult(httpresult, url);
        } catch (Exception e) {
            throw new AppException(e);
        }
    ...
    public JSONObject httpPost(String url, T t) throws AppException {
        try {
            HttpResult httpresult = HttpHelper.executePost(zuul_base_url + url, t,isencrpty);
            return parseHttpResult(httpresult, url);
        } catch (Exception e) {
            throw new AppException(e);
        }
    ...
    public JSONObject httpUploadFile(String url, File file, String file_name, String file_bus_type, String file_bus_id, String userid) throws AppException {
        try {
            HttpResult httpresult = HttpHelper.executeUploadFile(zuul_base_url + url, file, file_name, file_bus_type, file_bus_id, userid, isencrpty);
            return parseHttpResult(httpresult, url);
        } catch (Exception e) {
            throw new AppException(e);
        }
    ...
    public JSONObject httpUploadFile(String url, File file, String file_name, String file_bus_type, String file_bus_id, String userid, String desc) throws Exception {
        try {
            HttpResult httpresult = HttpHelper.executeUploadFile(zuul_base_url + url,  file, file_name, file_bus_type, file_bus_id, userid, desc, isencrpty);
            return parseHttpResult(httpresult, url);
        } catch (IOException e) {
            throw new AppException(e);
        }
    ...
    public JSONObject httpUploadFile_ForProvince(String url, File file, String file_name, String file_bus_type, String file_bus_id, String userid,String fileRandomFlag, String desc) throws Exception {
        try {
            HttpResult httpresult = HttpHelper.executeUploadFileProvince(zuul_base_url + url,  file, file_name, file_bus_type, file_bus_id, userid,fileRandomFlag,desc,isencrpty);
            return parseHttpResult(httpresult, url);
        } catch (IOException e) {
            throw new AppException(e);
        }
    ...
    public File httpDownLoadFile(String url, String localdir) throws AppException {
        File file;
        try {
            file = HttpHelper.executeDownloadFile(zuul_base_url + url,  localdir);
        } catch (IOException e) {
            throw new AppException(e);
        }
        return file;
