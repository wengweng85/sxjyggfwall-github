...
public class QueryPersonInfo1ServiceImpl implements QueryPersonInfo1Service {
	...
	public Data exec(Data request) {
        ...
        R result=  new ServiceCall().callService(INTERFACE_CONFIG_ID,INTERFACE_SCRIPT_ID,request.getBody());
        return StructUtil.RtoResponseData(request, result);
