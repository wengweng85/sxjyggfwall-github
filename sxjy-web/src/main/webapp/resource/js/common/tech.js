...
var requesturl=contextPath+'/comm/getTechQuery';
$(function() {
	...
	$("#makesure").click(function() {
		if($("#nodeid").val()==null || $("#nodeid").val() == "" ){
			...
			//window.close();
			parent.$('#aac200').val($("#nodeid").val());
			parent.$('#aac200_name').val($("#nodename").val());
			parent.$('#aac200_name').blur();
