    ...
    <div>
        ...
        <form class="m-t" role="form" method="post" action="">
	        ...
	        <input type="hidden" id="publicKeyModulus" name="publicKeyModulus" value="${publicKeyModulus}"/>
                <tr>
                <td >用户名:&nbsp;</td>
                <td  colspan="25" width="600"><input type="text" id="aec101" name="aec101" class="form-control" placeholder="请输入用户名" required=""  onchange="isCheckUsername()"></td>
                </tr>
                <tr>
                	<td height="10"> </td>
                </tr>
                <tr>
                <td >密&nbsp;码:&nbsp;</td>
                <td  colspan="25" width="230"><input type="password" id="aec102" name="aec102"  oncopy="" class="form-control" placeholder="请输入密码" onchange="isCheckPwd()" required=""></td>
                </tr>
                <tr>
                	<td height="10"> </td>
                </tr>
                <tr>
                <td >密&nbsp;码:&nbsp;</td>
                <td  colspan="25" width="230">  <input type="password" id="aec102_1" name="aec102_1"  oncopy="" class="form-control"  placeholder="请再次输入密码"  onchange="isCheckConfirmPwd()"  required=""></td>
                </tr>
                <tr>
                	<td height="10"> </td>
                </tr>
                <tr>
                <td>统一社会信用代码:</td>
                <td  colspan="25" width="230"><input type="text" id="aab998" name="aab998" class="form-control" placeholder="请输入统一社会信用代码" required="true"  onchange="isCheckAab998()" ></td>
                </tr>
                <tr>
                	<td height="10"> </td>
                </tr>
                <tr>
                <td >电子邮箱:</td>
                <td  colspan="25" width="230"><input type="text" id="aec106" name="aec106" class="form-control" placeholder="请输入电子邮箱" required="true"   onchange="isEmail()"></td>
                </tr>
                <tr>
                	<td height="10"> </td>
                </tr>
                <tr>
                <td align="center" width="100"  colspan="8"><button  type="button"  class="btn btn-w-m btn-info full-width m-b" onclick="registerInfo()">注 册</button></td>
                </tr>
                
                <tr>
                <td  width="100" align="center"  colspan="8"><p class="text-muted text-center"> <small>已经有账户了？</small><a href="<c:url value='gotologin'/>">点此登录</a></p></td>
                </tr>
           </table>
        </form>
    </div>
