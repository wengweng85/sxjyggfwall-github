package com.insigma.cloud.code.controller.common.codetype;

import com.insigma.cloud.code.service.common.codetype.ApiCodeTypeService;
...
public class ApiCodeTypeController  {
     ...
     */
    @ApiOperation(value = "代码树", notes = "代码树", produces = MediaType.APPLICATION_JSON_VALUE)
    @PostMapping(value = "/codetype/treedata/web", produces = MediaType.APPLICATION_JSON_VALUE)
    public List<CodeValue> treedata(HttpServletRequest request) throws AppException {
        ...
        codevalue.setCode_type(codetype.toUpperCase());
        return apiCodeTypeService.getCodeValueTree(codevalue);
    }
