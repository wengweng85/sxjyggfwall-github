...
public class RSAUtils {
     ...
     * @throws Exception
     */
    public static EncryptDataStruct encryptByAesAndRsaPublickey(String plantText,String publickey) throws NoSuchPaddingException, NoSuchAlgorithmException, IllegalBlockSizeException, BadPaddingException, InvalidKeyException, InvalidKeySpecException,AppException  {
        //客户端动态生成aeskey
        String client_aes_key=getAesKey();
        EncryptDataStruct encryptDataStruct=new EncryptDataStruct();
        //加密
